...
const headwordInfo: {
  ...
  sK: {
    icon: 'rare',
    styles: 'text-red-800 bg-red-200',
    descr: 'Search only kanji',
  },
  sk: {
    icon: 'rare',
    styles: 'text-red-800 bg-red-200',
    descr: 'Search only kana',
  },
};
...
const miscLabels: {
  ...
  fict: ['fiction', 'work of fiction'],
  form: ['formal', 'formal or literary form'],
  given: ['given name', 'given name or forename, gender not specified'],
  group: ['group', 'group (band, musical group, etc.)'],
